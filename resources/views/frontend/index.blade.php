    ...
    <div class="banner">
        ...
        <div class="container fill_height">
            <div class="row fill_height">
                <div class="banner_product_image"><img src="{{ asset('public/files/product/' . $bannerproduct->thumbnail) }}"
                            ...
                            <div class="owl-carousel owl-theme deals_slider">
                                ...
                                @foreach ($todaydeal as $row)
                                    ...
                                    <div class="owl-item deals_item">
                                        <div class="deals_image"><img src="{{ asset('public/files/product/' . $row->thumbnail) }}"
                                                alt="{{ $row->name }}"></div>
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <img src="{{ asset('public/files/product/' . $row->thumbnail) }}"
                                                        alt="{{ $row->name }}" height="100%" width="70%">
                                                </div>
                                            ...
                                            <div class="trends_category"><a
                                                ...
                                                <div class="trends_price">
                                                    ...
                                                    @else
                                                        ...
                                                        <del class="text-danger">{{ $setting->currency }}
                                                            {{ $row->selling_price }}</del>
                                                    @endif
                                                </div>
                                            </div>
                                    ...
                                    <div class="review d-flex flex-row align-items-start justify-content-start">
                                        ...
                                        <div class="review_content">
                                            ...
                                            <div class="review_text">
                                                <p style="text-align: justify;">{{ substr($row->review, 0, 110) }}..</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
